...
<div>
	<div id="barraIdentificacao">
        ...
        <form method="post" action="really_add_banner.php" enctype='multipart/form-data'>
        <div id="barraMenu">
        ...
        <div id="conteudoCentral" class="">   
			...
			<div class="frmAlteraSenha">
				<p>Preencha os dados a seguir:</p>
					<div class="fl linha">
						<p>Nome da empresa:</p>
						<p><input type="text" name="txtEmpresa" class="caixa" required autofocus></p>
					</div>
					<div class="fl linha">
						<p>Link da página:</p>
						<p><input type="text" name="txtLink" class="caixa" required autofocus></p>
					</div>
					<div class="fl linha">
						<p>Imagem:</p>
